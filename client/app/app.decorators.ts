...
module App{
    ...
    export function Component(slct:string, component: angular.IComponentOptions): any {
        return (target: any) => {
            ...
            angular.module("app").component(selector, component);
        }
    }
    /**
     * Config decorator.
    ...
    export function Config(): any {
        return (target: any) => {
            angular.module("app").config(target);
        };
    }
    ...
    export function Constant(name:string): any {
        return (Target: any) => {
            angular.module("app").constant(name, new Target());
        };
    }
    ...
    export  function Filter(name:string): any {
        return (target: any) => {
            angular.module("app").filter(name, () => { return target});
        };
    }
    ...
    export function Directive(slct:string, directiveOptions:IDirective): any {
        return (target: any) => {
            ...
            angular.module("app").directive(selector, ()=>{
    ...
    export function Service(name: string): any {
        return (target: any) => {
            angular.module("app").service(name, target);
        };
    }
